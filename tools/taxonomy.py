...
FMP/GICS industry string seen in the universe to one of 37 peer groups, each
with a fixed parent sector (a few industries are deliberately re-parented, e.g.
homebuilders to Industrials, packaging to Basic Materials, solar to Utilities).
...
form a usable equal-weight benchmark. An industry missing here falls back to
its (aliased) sector and no group; build_data.py reports every such name.
